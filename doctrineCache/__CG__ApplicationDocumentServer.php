...
namespace DoctrineMongoProxy\__CG__\Application\Document;
 ...
 */
class Server extends \Application\Document\Server implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'ipAddress', 'internalIpAddress', 'activeWebsiteLimit', 'activeWebsiteCount', 'version');
    }
